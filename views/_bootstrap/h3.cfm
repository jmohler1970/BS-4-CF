...
case "start" :
	...
	param attributes.id				= "";
	param attributes.isSafeHTML		= application.Bootstrap.isSafeHTML.contains("h3");
...
case "end" :     
	...
	if(variables.myClass != "")			variables.result &= '<h3 class="#encodeForHTMLAttribute(variables.myClass)#"';
