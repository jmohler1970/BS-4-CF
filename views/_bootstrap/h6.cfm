...
case "start" :
	...
	param attributes.cacheid			= "";
     param attributes.id				= "";
     param attributes.isSafeHTML		= application.Bootstrap.isSafeHTML.contains("h6");
...
case "end" :     
	...
	if(variables.myClass != "")				variables.result &= '<h6 class="#encodeForHTMLAttribute(variables.myClass)#"';
